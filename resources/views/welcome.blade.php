...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class=" w-full h-screen flex justify-between gap-1 z-50">
         <div class="w-1/2  mx-auto justify-center flex flex-col form-des">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-3 relative">
                    <label for="name" class="block text-gray-950 text-sm font-bold mb-2">Name</label>
                    ...
                    @enderror
                    <span class="mdi mdi-account absolute right-6 bottom-1 cursor-pointer"></span>
                </div>
                <div class="mb-3 relative">
                ...
                <div class="mb-3 relative">
                    <label for="password-confirm" class="block text-gray-950 text-sm font-bold mb-2">Confirm Password</label>
         ...
         <div class=" flex flex-col w-1/2 rounded-l-lg login-image">
